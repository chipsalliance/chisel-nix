...
in
{
  ...
  "com.lihaoyi_mainargs_2.13-0.5.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.jar" "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.pom" ];
...
# Project Source Hash:sha256-pCc9X9plqzsjO+8DAvYq2J1w0dU7qpoTq8QQRdzy7YU=
